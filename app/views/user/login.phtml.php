...
<html lang="en">
    <head>
        ...
        <title>Responsive blab like homepage, Registration and login with twitter bootstrap 3.0 - wsnippets.com</title>
        <link href="/blab/public/css/bootstrap.css" rel="stylesheet">
        <link href="/blab/public/css/sticky-footer.css" rel="stylesheet">
        <link href="/blab/public/css/custom.css" rel="stylesheet">
    </head>
    ...
    <body>
        <div id="wrap">
            ...
            <div class="container" id="home">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <h3 class="slogan">
                            blab helps you connect and share with the people in your life.
                        </h3>
        ...
        <script src="/blab/public/js/menu.js"></script>
        <script src="/blab/public/js/inspinia.js"></script>

        <script src="/blab/public/js/bootstrap.js"></script>
        <script src="/blab/public/js/slimscroll.js"></script>
        <script src="/blab/public/js/pagination.js"></script>
